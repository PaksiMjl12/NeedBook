...
public class login extends javax.swing.JFrame {
    ...
    public static Connection koneksiDB()throws SQLException{
        if(mysqlkonek==null) {
            try{
                String DB = "jdbc:mysql://localhost:3306/needbook";
                String user ="root";
                String pass ="";
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Asus Rog", 1, 48)); // NOI18N
        jLabel1.setText("LOGIN");

        jLabel2.setFont(new java.awt.Font("Asus Rog", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Password");

        jLabel3.setFont(new java.awt.Font("Asus Rog", 0, 18)); // NOI18N
